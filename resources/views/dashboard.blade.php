    ...
    <div class="row">
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        <h5 class="card-title mb-0">Profesores registrados</h5>
                    </div>
                    <div class="row d-flex align-items-center mb-4">
                        ...
                        <div class="col-4 text-right">
                            <span class="text-muted">{{ $totalProfesores }} <i
                            class="mdi mdi-arrow-up text-success"></i></span>
                        </div>
                    </div>
                    <div class="progress shadow-sm" style="height: 5px;">
                        <div class="progress-bar bg-success" role="progressbar" style="width: {{ intval(( $profesoresRegistrados * 100 ) / $totalProfesores) }}%;">
                        </div>
                    </div>
                </div>
                <!--end card body-->
